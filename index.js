...
const SUB_PATH = process.env.SUB_PATH || 'awaken';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3030;        // http服务订阅端口
const UUID = process.env.UUID || 'fbf52a84-7302-4426-94c4-8cd109fdba3a'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
